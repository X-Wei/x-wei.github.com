...
![](progfun2_lec1_forexpr/pasted_image002.png)
...
### Function1 Trait
![](progfun2_lec1_forexpr/pasted_image003.png)

### subclass a function type
function types can also be extended ! 

![](progfun2_lec1_forexpr/pasted_image005.png)
...
![](progfun2_lec1_forexpr/pasted_image006.png)

The f definition is translated to: 

![](progfun2_lec1_forexpr/pasted_image007.png)

But the ``PartialFunction`` will only apply for level 1: 

![](progfun2_lec1_forexpr/pasted_image008.png)
...
![](progfun2_lec1_forexpr/pasted_image009.png)
...
![](progfun2_lec1_forexpr/pasted_image011.png)

![](progfun2_lec1_forexpr/pasted_image013.png)

### For expressions

for-expr can *simplify combinations of core methods*. 

![](progfun2_lec1_forexpr/pasted_image014.png)

**the** **lhs of a generator can also be a pattern!**

![](progfun2_lec1_forexpr/pasted_image015.png)
...
![](progfun2_lec1_forexpr/pasted_image016.png)
...
![](progfun2_lec1_forexpr/pasted_image017.png)
...
![](progfun2_lec1_forexpr/pasted_image018.png)

⇒ define map and flatMap on ``Try`` type. 

![](progfun2_lec1_forexpr/pasted_image019.png)
