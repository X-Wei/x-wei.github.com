...
![](_images/algoI_week5_1/pasted_image.png)   
**search**   
...
![](_images/algoI_week5_1/pasted_image001.png)   ![](_images/algoI_week5_1/pasted_image002.png)    ![](_images/algoI_week5_1/pasted_image003.png)   
...
![](_images/algoI_week5_1/pasted_image004.png) ![](_images/algoI_week5_1/pasted_image005.png)   
   
**splitting a 4-node**: can be done in constant time (*local transformation*).    
![](_images/algoI_week5_1/pasted_image006.png)   
...
![](_images/algoI_week5_1/pasted_image007.png)   
   
**performance**   
every path from root to null link has the same length.    
![](_images/algoI_week5_1/pasted_image008.png)   
...
![](_images/algoI_week5_1/pasted_image009.png)   
   
* 4-node用两个red link表示:    
   
![](_images/algoI_week5_1/pasted_image030.png) ⇒ ![](_images/algoI_week5_1/pasted_image029.png) or ![](_images/algoI_week5_1/pasted_image027.png) or ![](_images/algoI_week5_1/pasted_image028.png)   
   
example:    
![](_images/algoI_week5_1/pasted_image010.png)   
...
![](_images/algoI_week5_1/pasted_image011.png)   
...
![](_images/algoI_week5_1/pasted_image012.png)   
...
![](_images/algoI_week5_1/pasted_image013.png)   ![](_images/algoI_week5_1/pasted_image014.png)   
...
![](_images/algoI_week5_1/pasted_image015.png) ![](_images/algoI_week5_1/pasted_image016.png)   
   
``private Node rotateRight(Node h){...}``   
   
right rotation 是为了应对这种情况:    
![](_images/algoI_week5_1/pasted_image024.png) rotateRight(c) ⇒ ![](_images/algoI_week5_1/pasted_image023.png)   
   
**color-flip**   
(split a 4-node, with three kyes — two red links)   
![](_images/algoI_week5_1/pasted_image017.png)  ![](_images/algoI_week5_1/pasted_image018.png)   
...
![](_images/algoI_week5_1/pasted_image034.png)	⇒ rotateLeft(a)   
   
2. *left =red, left.right = red [这个不会出现, 因为这对于下一层来说是case 1..]*   
   
![](_images/algoI_week5_1/pasted_image039.png) 	⇒ rotateLeft(e) ⇒ 变为case 3    
   
3. *left = red, left.left = red*   
   
![](_images/algoI_week5_1/pasted_image035.png)	⇒ rotateRight(s) ⇒ 变为case 4   
	   
   
4. *left = red. right = red*   
   
![](_images/algoI_week5_1/pasted_image036.png)		⇒ flipColor(r)   
   
几个状态之间的转化:    
![](_images/algoI_week5_1/pasted_image038.png)   
...
![](_images/algoI_week5_1/pasted_image041.png)   
...
summery:    
![](_images/algoI_week5_1/pasted_image042.png)   
...
![](_images/algoI_week5_1/pasted_image043.png)   
   
Searching   
---------   
similar to BST/2-3tree   
ex.   
 ![](_images/algoI_week5_1/pasted_image044.png)   
...
---------   
similar to 2-3 tree   
![](_images/algoI_week5_1/pasted_image045.png)   
   
Analysis   
--------   
![](_images/algoI_week5_1/pasted_image046.png)   
...
![](_images/algoI_week5_1/pasted_image047.png)     
